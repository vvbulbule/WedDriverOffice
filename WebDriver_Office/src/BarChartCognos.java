...
public class BarChartCognos {
	...
	public void testChart1() throws InterruptedException {
		...
		WebElement toolTip = driver.findElement(By.xpath("//div[contains(@class,'toolbarDivider')]"));
		System.out.println("Specify Chart Type Data");
		for (WebElement el:elements)
		{
			el.click(); 
			String chartValue = toolTip.getAttribute("title");
